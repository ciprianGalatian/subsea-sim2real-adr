...
The script is pretty smart—it will spot any synthetic datasets you've generated in the data folder and ask you which one you want to use. It automatically maps your synthetic classes to your golden real dataset and sets up the 80/20 train/val split for you.
